...
OplogCheck.olderMeteor = function() {
  return {
    code: "OLDER_METEOR",
    reason: "This Meteor version does not support oplog",
...
OplogCheck.limitButNoSort = function(options) {
  var options = cursorDescription.options;
...
OplogCheck._070 = function(cursorDescription) {
  ...
  var exists$ = return _.any(cursorDescription.selector, function (value, field) {
    if (field.substr(0, 1) === '$')
      return true;
  });
  ...
  var onlyScalers = return _.all(cursorDescription.selector, function (value, field) {
...
Kadira.checkForOplog = function(cursorDescription, observerDriver) {
