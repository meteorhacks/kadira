      ...
      try{
        ...
        if(type == 'observeChanges' || type == 'observe') {
          ...
          if(type == 'fetch') {
            ...
            var docSize = Kadira.docSzCache.getSize(coll, query, opts, ret);
            endData.docSize = docSize * ret.length;
            ...
            if(kadiraInfo) {
              if(kadiraInfo.trace.type === 'method') {
                ...
                Kadira.models.pubsub.trackDocSize(kadiraInfo, "cursorFetches", docSize);
              }
            } else {
