    ...
    cursorProto[type] = function() {
      ...
      try{
        ...
        if(type == 'observeChanges' || type == 'observe') {
          ...
          if(ret._multiplexer && ret._multiplexer._observeDriver) {
            ...
            endData.noOfCachedDocs = Object.keys(ret._multiplexer._cache.docs).length;
          }
        } else if(this._synchronousCursor && this._synchronousCursor._dbCursor){
          //for other cursor operation
          endData.docsFetched = this._synchronousCursor._dbCursor.totalNumberOfRecords;
        }
