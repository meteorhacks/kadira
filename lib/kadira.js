...
Kadira.connect = function(appId, appSecret, options) {
  ...
  Kadira.options.authHeaders = {
    'APM-APP-ID': Kadira.options.appId,
    'APM-APP-SECRET': Kadira.options.appSecret
  };
...
Kadira._sendInitialPayload = function () {
  Kadira._send({
    release: Meteor.release,
    packages: _.keys(Package),
    versions: _.pick(__meteor_runtime_config__, [
      'autoupdateVersion',
